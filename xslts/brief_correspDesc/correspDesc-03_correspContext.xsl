...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.tei-c.org/ns/1.0"
    ...
    <!--<xsl:param name="schnitzler-briefe_cmif"
        select="document('https://raw.githubusercontent.com/arthur-schnitzler/schnitzler-briefe-arbeit/refs/heads/main/indices/schnitzler-briefe-cmif.xml')"/>-->
    <xsl:param name="schnitzler-briefe_cmif"
        select="document('../../indices/schnitzler-briefe-cmif.xml')"/>
